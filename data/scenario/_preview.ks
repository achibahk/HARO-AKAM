...
[mask time=10]
[bg  storage="1711daily10n1_sample.jpg"  time="10"  ]
[playbgm  volume="100"  time="1000"  loop="true"  storage="Magic_in_the_Garden.ogg"  ]
[tb_show_message_window] 
[chara_show  name="HARO"  time="10"  wait="true"  storage="chara/1/haro1.png"  width="500"  height="500"  left="256"  top="27"  reflect="false"  ]
[mask_off time=10]
...
[glink  color="pink"  storage="scene1.ks"  size="20"  text="跳去H&nbsp;SCENE"  target="*shiyu_H_scene"  x="392"  y="339"  width=""  height=""  _clickable_img=""  ]
[s  ]
*start_game_fake
