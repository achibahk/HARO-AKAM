...
#
[font color=TEAL]赤井脫下襯衫，隨手從衣櫃中抓了件T恤套上，接著目光又移向吉他。[p]
那是把老舊的吉他。[p]
...
[chara_mod  name="REI"  time="600"  cross="false"  storage="chara/2/A5-2-1.png"  ]
[tb_start_text mode=1 ]
#
[font color=TEAL]聽到吉他聲時還以為是錯覺，抱著疑惑走進房間一看，果不其然有人正彈著自己的吉他。[resetfont][p]
[_tb_end_text]

[chara_mod  name="REI"  time="600"  cross="false"  storage="chara/2/A5-8-2.png"  ]
[tb_start_text mode=1 ]
#降谷零
赤井……？[p]
#
...
[chara_mod  name="REI"  time="600"  cross="false"  storage="chara/2/A5-2-2.png"  ]
[tb_start_text mode=1 ]
#降谷零
...
[tb_image_show  time="1000"  storage="default/波BE_彈吉他.jpg"  width="960"  height="640"  name="img_24"  ]
[wait  time="3000"  ]
[tb_show_message_window  ]
[tb_start_text mode=1 ]
#降谷零
...
[chara_mod  name="REI"  time="600"  cross="false"  storage="chara/2/A5-3-2.png"  ]
[tb_start_text mode=1 ]
#降谷零
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-5-2.png"  ]
[tb_start_text mode=1 ]
#降谷零
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-4-1-Y.png"  ]
[tb_start_text mode=1 ]
#
...
#
[font color=TEAL]赤井先是脫下襯衫，隨手從衣櫃中抓了件T恤套上，接著目光又移向筆電，輕輕將它抽出。[resetfont][p]
#
...
[tb_hide_message_window  ]
[tb_image_show  time="1000"  storage="default/威士忌_斜.png"  width="592"  height="482"  x="150"  y="35"  _clickable_img=""  name="img_47"  ]
[wait  time="600"  ]
[tb_show_message_window  ]
[tb_start_text mode=1 ]
#
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-8-7.png"  ]
[tb_start_text mode=1 ]
#降谷零
嗯？你、啊！[p]
[_tb_end_text]
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-8-1.png"  ]
[tb_start_text mode=1 ]
#
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-3-1.png"  ]
[tb_start_text mode=1 ]
#
...
[chara_mod  name="REI"  time="600"  cross="false"  storage="chara/2/A5-3-7.png"  ]
[tb_start_text mode=1 ]
#降谷零
為什麼……原來連你也被困在回憶中……[p]
我還以為只有我一個人在痛苦……[p]
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-3-5.png"  ]
[tb_start_text mode=1 ]
#降谷零
...
#
[font color=TEAL][p]
面對他人釋出的善意與溫暖，降谷仍舊像以往那樣用打趣、嘲諷的方式應對。[p]
但赤井知道，他只是不習慣，甚至有些逃避。[p]
從小到大，他都是一個人撐過來。[p]
對尚未熟悉之人毫無目的且突如其來的友善，為了保護自己免於傷害，他總是予以抗拒優先。[resetfont][p]
[_tb_end_text]

[tb_start_text mode=1 ]
#
[font color=TEAL]即使赤井非常明白這點，他還是決意說出真話。[resetfont][p]
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-1-2.png"  ]
[tb_start_text mode=1 ]
#降谷零
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-4-3.png"  ]
[tb_start_text mode=1 ]
#
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-6-3.png"  ]
[tb_start_text mode=1 ]
#降谷零
嗯，這也是那人所希望的吧。[p]
...
[chara_mod  name="REI"  time="600"  cross="true"  storage="chara/2/A5-1-5.png"  ]
[tb_start_text mode=1 ]
#降谷零
